...
We thus define specific features of our analysis. 
\begin{description}
...
Now it is possible to define the equations of the analysis.
...
\paragraph{}
blablabla Moreover, we will consider $\{x, y\}$ as the variable x equal to y. Please notice that this last statement has different meanings depending on the fact that the variable consist in an object or in a primitive elements, but we will see this later in a more precise way. blablabla\\

BLABABLA Risulta quindi necessario dover utilizzare una catena/array di riferimenti, per sapere tutta la lista di variabili che ipotizzate sensibili che sono collegate. Ci\`o ci permetterebbe inoltre di gestire tutte le problematiche relative alle variabili passate per riferimento.\\
